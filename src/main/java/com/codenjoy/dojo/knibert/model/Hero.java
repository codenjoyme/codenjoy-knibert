...
import com.codenjoy.dojo.knibert.model.artifacts.Affectable;
import com.codenjoy.dojo.knibert.model.artifacts.Tail;
import com.codenjoy.dojo.knibert.services.Event;
...
public class Hero extends PlayerHero<Field> implements Affectable, Iterable<Tail> {
    ...
    public String toString() {
        return String.format("Hero[%s, %s]", direction, elements.toString());
    }
